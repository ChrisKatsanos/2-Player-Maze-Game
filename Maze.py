...
while not done:
    ...
    wlIns5 = pygame.draw.rect(screen, (255, 0, 0), pygame.Rect(430, 340, 30, 200))  # wall inside n.5 (kath)
    ...
    wlIns8 = pygame.draw.rect(screen, (255, 0, 0), pygame.Rect(377, 240 , 200 , 30))  # wall inside n.8 (oriz)
    ...
    wlIns11 = pygame.draw.rect(screen, (255, 0, 0), pygame.Rect(250, 340 , 180 , 25))  # wall inside n.11 (oriz)
    ...
    Gametitle = Font.render("2 player maze", True , (255, 255, 255))
    screen.blit(Gametitle, (270, 0))
